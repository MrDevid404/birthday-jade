...
const Slideshow = ({ onComplete }: SlideshowProps) => {
  ...
  <div className="flex justify-center items-start md:items-center min-h-screen">
    ...
    >
      <div className="card-birthday relative bg-white rounded-2xl shadow-xl p-6 md:p-8">
        ...
        <div className="flex items-center justify-between mt-6">
          ...
          <button
            onClick={nextSlide}
            className="p-2 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-soft"
          >
